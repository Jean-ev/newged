...
<div class="page-header">
  <div>
    <h1 class="page-title">Fichiers Récents</h1>
    <p class="page-subtitle">Vos derniers fichiers modifiés</p>
  </div>
</div>
  ...
  <table class="file-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="color:#6B7280;">{{ $doc->updated_at->diffForHumans() }}</td>
...
<div class="table-card" style="text-align:center; padding:56px; color:#9CA3AF;">
  ...
  <p style="font-size:15px; font-weight:600; color:#6B7280; margin-bottom:6px;">Aucun fichier récent</p>
</div>
@endif
